\section{Experiment 5-8: Temporal Forecasting}
...
\input{sections/4_experiments/plots/global_forecasting.tex}
\input{sections/4_experiments/tables/global_forecasting_grid_search_metrics.tex}
\input{sections/4_experiments/tables/global_forecasting_random_search_metrics.tex}
...
\input{sections/4_experiments/tables/global_forecasting_tuning_time.tex}
...
\input{sections/4_experiments/plots/japan_pwg_forecasting.tex}
\input{sections/4_experiments/tables/japan_pwg_forecasting_metrics.tex}

Unlike the global plastics production series, the Japan plastic waste generation series is not monotonic. Figure~\ref{fig:japan_pwg_forecasting} shows that the trend increases in the earlier years, declines sharply, and then partially recovers. This makes the task a useful check of whether flexible regression models can handle short and irregular environmental time series.


Table~\ref{tab:japan_pwg_forecasting_metrics} shows that exponential smoothing performs best across all reported metrics, with an MAE of \(1.379 \times 10^5\), an RMSE of \(1.424 \times 10^5\), an \(R^2\) of 0.374, a WAPE of 3.50\%, and a MAPE of 3.55\%. The SVR variants and Theil--Sen regression produce competitive percentage errors, but they do not outperform exponential smoothing on the main metrics. Ridge regression performs especially poorly, suggesting that a polynomial trend fitted to this short series is too rigid or unstable for the observed trajectory.
...
\input{sections/4_experiments/tables/multivariate_forecasting_japan_metrics.tex}
\input{sections/4_experiments/tables/multivariate_forecasting_slovenia_metrics.tex}
