...
\begin{figure}[H]
	...
	\subfloat[Theil-Sen regression.]{
		\includegraphics[width=0.45\textwidth]{figures/global_forecasting_theil-sen-regression.png}
	}
	\hfill
...
\begin{table}[!ht]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		\hline
	\end{tabular}
	\label{tab:forecasting_results_grid_search}
\end{table}
...
\begin{table}[!ht]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		\hline
	\end{tabular}
	\label{tab:forecasting_results_random_search}
\end{table}
...
Table~\ref{tab:forecasting_results_grid_search} and Table~\ref{tab:forecasting_results_random_search} indicate that SVR achieved the best overall performance among all evaluated methods. Under the random search tuning setting, SVR attained the lowest MAE, RMSE, WAPE, and MAPE, as well as the highest \(R^2\) value. Under the grid search setting, SVR also remained the top-performing method, although its performance was slightly inferior to that of the random search setting.
