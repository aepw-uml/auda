\begin{table}[!ht]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		Gaussian Process Regression                  & \(1.375 \times 10^6\)          & \(1.742 \times 10^6\)          & -7.715             & 3.92\%              \\
		\textbf{Support Vector Regression}           & \(\mathbf{4.437 \times 10^5}\) & \(\mathbf{5.705 \times 10^5}\) & \(\mathbf{0.065}\) & \(\mathbf{1.26}\)\% \\
		Support Vector Regression\textsuperscript{*} & \(1.430 \times 10^6\)          & \(1.803 \times 10^6\)          & -8.335             & 4.08\%              \\
		\hline
	\end{tabular}
