...
\begin{table}[!ht]
	\centering
	\caption{\centering Temporal forecasting performance for global plastic production using random-search tuning for tunable models, averaged over 16 runs with test \(n=5\) per run. The \textsuperscript{*} marker denotes the SVR variant with \(\gamma\) tuning enabled.}
