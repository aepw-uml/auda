\begin{table}[!ht]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		\midrule
		NN Forecasting              & \(3.264 \times 10^5\)          & \(4.157 \times 10^5\)          & -2.945              & 6.99\%              \\
		Support Vector Regression   & \(3.736 \times 10^5\)          & \(4.350 \times 10^5\)          & -3.270              & 8.00\%              \\
		Gaussian Process Regression & \(\mathbf{2.959 \times 10^5}\) & \(\mathbf{3.826 \times 10^5}\) & \(\mathbf{-2.332}\) & \(\mathbf{6.33}\)\% \\
		\hline
	\end{tabular}
