...
\begin{table}[!ht]
	\centering
	\caption{\centering Imputation performance for artificially masked total resin consumption in the United States using the \texttt{YearTRC (US)} dataset, averaged over 16 runs with test \(n=2\) per run.}
