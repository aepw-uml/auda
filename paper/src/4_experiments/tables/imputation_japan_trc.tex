...
\begin{table}[!ht]
	\centering
	\caption{\centering Imputation performance for artificially masked total resin consumption in Japan using the \texttt{YearTRC (Japan)} dataset, averaged over 16 runs with test \(n=2\) per run.}
