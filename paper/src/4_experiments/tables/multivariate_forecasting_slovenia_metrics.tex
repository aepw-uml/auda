\begin{table}[!ht]
	...
	\begin{tabular}{@{}lccccc@{}}
		...
		\midrule
		NN Forecasting                     & \(7.031 \times 10^3\)          & \(7.994 \times 10^3\)          & -1.744              & 10.92\%             \\
		\textbf{Support Vector Regression} & \(\mathbf{5.580 \times 10^3}\) & \(\mathbf{7.157 \times 10^3}\) & \(\mathbf{-0.974}\) & \(\mathbf{8.67}\)\% \\
		Gaussian Process Regression        & \(1.090 \times 10^4\)          & \(1.121 \times 10^4\)          & -3.842              & 16.94\%             \\
		\hline
	\end{tabular}
