\begin{figure}[H]
	...
	\subfloat[\texttt{YearTRC (United States)} with GPR.]{
		\includegraphics[width=0.45\textwidth]{figures/united_states_ppc_imputation_gpr.png}
	}
	\hfill
	\subfloat[\texttt{YearTRC (United States)} with SVR.]{
		\includegraphics[width=0.45\textwidth]{figures/united_states_ppc_imputation_svr.png}
	}
