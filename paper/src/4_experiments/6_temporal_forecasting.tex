...
Table~\ref{tab:forecasting_japan_pwg_metrics} shows that SVR has the best values across all reported metrics, with an MAE of \(4.442 \times 10^5\), an RMSE of \(5.336 \times 10^5\), an \(R^2\) of 0.182, and a WAPE of 1.27\%, followed by the naive persistence baseline by WAPE, while exponential smoothing performs poorly on this short, non-monotonic series (test set: 2 observations).
